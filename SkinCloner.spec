...
a = Analysis(
    ...
    hiddenimports=['numpy', 'cv2', 'psutil', 'requests', 'rapidfuzz', 'websocket', 'mss', 'PIL', 'PIL.Image', 'PIL.ImageTk', 'tesserocr', 'Pillow', 'pystray', 'pystray._base', 'pystray._win32', 'pystray._darwin', 'pystray._gtk', 'pystray._xorg', 'pystray._util'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
